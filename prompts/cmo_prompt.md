...
1. Business Fit - 20 điểm:
   - Có hướng tới răng sứ/phục hình/implant không?
   - Có tạo nhu cầu tư vấn không?
   - Có phù hợp khách hàng có khả năng chi trả không?
   - Có thể triển khai thành funnel không?
2. Lead Intent - 20 điểm:
   - CTA có khiến khách inbox không?
   - Nội dung có tạo câu hỏi cá nhân hóa không?
   - Có lead magnet đủ mạnh không?
   - Có phân loại lead nóng/lạnh được không?
3. Differentiation - 15 điểm:
   - Có làm rõ SmileUp khác đối thủ không?
   - Có nhấn mạnh minh bạch chỉ định, an toàn, tư vấn cá nhân hóa không?
   - Có tránh cuộc đua giảm giá không?
4. Viral Potential - 15 điểm:
   - Hook có đủ mạnh không?
   - Có yếu tố "ngược số đông" nhưng đúng chuyên môn không?
   - Có checklist/câu chuyện/tình huống dễ lưu/chia sẻ không?
   - Có tạo bình luận tự nhiên không?
5. Customer Truth - 10 điểm:
   - Có đúng nỗi sợ thật của khách Việt không?
   - Có chạm vào lo lắng về đau, mài răng, chi phí, bền, biến chứng, bị tư vấn quá tay không?
   - Có ngôn ngữ đời thường không?
6. Creative Fit - 10 điểm:
   - Visual/video có rõ trong 3 giây đầu không?
   - Có dễ làm carousel/reels không?
   - Có không cần dùng hình ảnh gây sốc không?
7. Compliance & Medical Safety - 10 điểm:
   - Không claim quá mức.
   - Không body-shaming.
   - Không chỉ định thay bác sĩ.
   - Có disclaimer thăm khám.
   - Có thể bổ sung thông tin pháp lý trước khi chạy quảng cáo.
